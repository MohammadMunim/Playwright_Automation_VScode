...
test('Demo login test web1', async ({page})=>{
...
test('Login demo test 2', async ({ page }) => {
   ...
   await page.locator('p:has-text("firstName lastName")').click()
...
test.only('Login demo test 3', async ({ page }) => {
   ...
   await page.locator('text=Logout').click();
   await page.waitForURL('https://admin-demo.nopcommerce.com/login?ReturnUrl=%2Fadmin%2F%27%29%3B');
   await page.close();
})
*/